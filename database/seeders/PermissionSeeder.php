...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'Read-SubCategories', 'guard_name' => 'user-api']);

        Permission::create(['name' => 'Create-Task', 'guard_name' => 'user-api']);
        Permission::create(['name' => 'Read-Tasks', 'guard_name' => 'user-api']);
        Permission::create(['name' => 'Update-Task', 'guard_name' => 'user-api']);
        Permission::create(['name' => 'Delete-Task', 'guard_name' => 'user-api']);
    }
}

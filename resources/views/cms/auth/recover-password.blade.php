        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form>
                    ...
                    <div class="input-group mb-3">
                        <input type="password" class="form-control" id="password_confirmtion" placeholder="Confirm Password">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-lock"></span>
                            </div>
    ...
    <script>
        function resetPassword() {
            axios.post('reset-password', {
                    ...
                    password_confirmation: document.getElementById('password_confirmtion').value,
                    token: '{{$token}}',
                    email: '{{$email}}',
